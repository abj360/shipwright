...
Contains:
    ...
    test_threshold_boundary_reads_ready(): a score exactly on the bar passes
"""

from agent.judgeline_client import READY_THRESHOLD
from tui.widgets.pr_card import (
    NOT_READY_BADGE,
    READY_BADGE,
    UNSCORED_BADGE,
    badge_for,
...
def test_threshold_boundary_reads_ready() -> None:
    """Asserts a score sitting exactly on the threshold is treated as ready."""
    badge = badge_for(read_score({"score": READY_THRESHOLD}))
